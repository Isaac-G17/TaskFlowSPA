        ...
        <article class="rounded-3xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-50">
          <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            ...
            <div class="flex gap-3">
              ...
              <a class="rounded-full border border-blue-200 px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-50" href="/tasks/delete">Eliminar</a>
            </div>
          </div>
        </article>
...
export function setupTasksView() {
  return console.log("Setup para vista de tareas");
}
